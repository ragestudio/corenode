...
test('getContent with opts.jsFiles', async () => {
    ...
    expect(content.split('<body>')[1]).toContain('<script src="/foo.js"></script>');
});
test('getContent with opts.headJSFiles', async () => {
    ...
    expect(content.split('</head>')[0]).toContain('<script src="/foo.js"></script>');
});
test('getContent with scripts', async () => {
    ...
    expect(content.split('<body>')[1]).toContain('<script src="//a.ali.com/a.js"></script>');
});
test('getContent with css', async () => {
    ...
    expect(content.split('</head>')[0]).toContain('<link rel="stylesheet" href="//a.alicdn.com/a.css" />');
