...
class Html {
  ...
  getHtmlPath(path) {
    ...
    if (((_this$config$exportSt = this.config.exportStatic) === null || _this$config$exportSt === void 0 ? void 0 : _this$config$exportSt.htmlSuffix) || path === 'index.html') {
      return `${path}`;
    } else {
  ...
  getRelPathToPublicPath(path) {
    ...
    return Array(((_this$config$exportSt2 = this.config.exportStatic) === null || _this$config$exportSt2 === void 0 ? void 0 : _this$config$exportSt2.htmlSuffix) ? len : len - 1).join('../') || './';
  }
  ...
  getAsset(opts) {
    ...
    if ((_this$config$exportSt3 = this.config.exportStatic) === null || _this$config$exportSt3 === void 0 ? void 0 : _this$config$exportSt3.dynamicRoot) {
