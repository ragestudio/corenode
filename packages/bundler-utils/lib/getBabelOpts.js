...
function getBabelOpts({
  ...
  return _objectSpread(_objectSpread({}, getBasicBabelLoaderOpts({
    ...
    presets: [[require.resolve('@nodecorejs/babel-preset-umi/app'), presetOpts], ...(config.extraBabelPresets || [])],
...
function getBabelDepsOpts({
  ...
  return _objectSpread(_objectSpread({}, getBasicBabelLoaderOpts({
    ...
    presets: [[require.resolve('@nodecorejs/babel-preset-umi/dependency'), {
      nodeEnv: env,
