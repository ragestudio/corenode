...
var _NodeTemplatePlugin = _interopRequireDefault(
  require('webpack/lib/node/NodeTemplatePlugin'),
);

var _NodeTargetPlugin = _interopRequireDefault(
  require('webpack/lib/node/NodeTargetPlugin'),
);

var _LibraryTemplatePlugin = _interopRequireDefault(
  require('webpack/lib/LibraryTemplatePlugin'),
);

var _SingleEntryPlugin = _interopRequireDefault(
  require('webpack/lib/SingleEntryPlugin'),
);

var _LimitChunkCountPlugin = _interopRequireDefault(
...
function hotLoader(content, context) {
  ...
  return `${content}
    if(module.hot) {
      // ${Date.now()}
      var cssReload = require(${_loaderUtils.default.stringifyRequest(
        context.context,
        _path.default.join(__dirname, 'hmr/hotModuleReplacement.js'),
      )})(module.id, ${JSON.stringify(
    _objectSpread({}, context.options, {
...
function pitch(request) {
  ...
  new _SingleEntryPlugin.default(
    this.context,
    `!!${request}`,
    pluginName,
  ).apply(childCompiler);
    ...
    const addDependencies = (dependencies) => {
      ...
      for (const dependency of dependencies) {
        ...
        this._module.addDependency(
          new _CssDependency.default(dependency, dependency.context, count),
        );
