        ...
        if (config.styleLoader) {
            ...
            if (type === BundlerConfigType.csr && !config.styleLoader) {
                rule
                    ...
                    .loader(miniCSSExtractPluginLoaderPath ||
        ...
        rule
            ...
            plugins: () => [
                ...
                require('postcss-preset-env')({
                    // TODO: set browsers
                    autoprefixer: type === BundlerConfigType.ssr
                        ? false
                        : {
                            ...config.autoprefixer,
...
export default function ({ type, config, webpackConfig, isDev, disableCompress, browserslist, miniCSSExtractPluginPath, miniCSSExtractPluginLoaderPath, }) {
    // css
    createCSSRule({
        type,
        webpackConfig,
