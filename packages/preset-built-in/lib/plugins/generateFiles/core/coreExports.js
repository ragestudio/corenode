...
function generateExports({
  ...
  const specifiersStrArr = item.specifiers.map(specifier => {
    if (typeof specifier === 'string') {
      ...
      (0, _assert().default)(!coreExportsHook[specifier], `${specifier} is Defined, you can use 'exported' to set alias.`);
...
function _default(api) {
  api.onGenerateFiles( /*#__PURE__*/_asyncToGenerator(function* () {
    const coreExports = yield api.applyPlugins({
      key: 'addcoreExports',
