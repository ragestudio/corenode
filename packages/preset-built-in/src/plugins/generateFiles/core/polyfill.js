...
export default (api) => {
    ...
    api.onGenerateFiles(() => {
        ...
        api.writeTmpFile({
            content: api.utils.Mustache.render(readFileSync(join(__dirname, 'polyfill.tpl'), 'utf-8'), {
    ...
    api.chainWebpack((memo) => {
        memo.resolve.alias.set('regenerator-runtime', dirname(require.resolve('regenerator-runtime/package')));
        return memo;
    });
};
