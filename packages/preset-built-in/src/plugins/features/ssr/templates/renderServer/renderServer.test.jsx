...
test('renderServer normal', async () => {
    ...
    expect(serverResult.pageHTML).toEqual('<div data-reactroot=""><h1>foo</h1></div>');
    ...
    expect(serverResultBar.pageHTML).toEqual('<div data-reactroot=""><h1>bar</h1></div>');
});
test('renderServer layout', async () => {
    ...
    expect(serverResult.pageHTML).toEqual('<div><h1>true</h1><h2>titleLayout</h2><h3>foo</h3><h4>foo</h4><h5>layoutCtx</h5></div>');
});
...
test('renderServer plugin modifyGetInitialPropsCtx', async () => {
    ...
    expect(serverResult.pageHTML).toEqual('<div><h1>Hello SSR，Hello Desc</h1></div>');
});
